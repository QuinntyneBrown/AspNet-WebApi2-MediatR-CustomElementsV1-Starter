...
namespace AspNetWebApi2MediatRCustomeElementsV1Starter.Features.Users
{
    public class RegisterCommand
    {
        ...
        {
            public RegisterHandler(AspNetWebApi2MediatRCustomeElementsV1StarterContext context, ICache cache, Lazy<IAuthConfiguration> lazyAuthConfiguration, IMediator mediator)
            {
                _context = context;
                _cache = cache;
                _mediator = mediator;
